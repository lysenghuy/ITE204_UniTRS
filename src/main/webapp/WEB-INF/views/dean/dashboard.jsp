...
<body>
    <nav class="navbar navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <i class="bi bi-mortarboard-fill me-2"></i>UniTRS Dean
            </a>
    ...
    <div class="container mt-5 text-center">
        ...
        <h2 class="mt-3">Dean Dashboard</h2>
        <p class="text-muted">Coming Soon — Course catalog, term bundling, and section scheduling will appear here.</p>
    </div>
